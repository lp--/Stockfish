...
namespace {
  ...
  const Score ChainMember[FILE_NB][RANK_NB] = {
    { S(0, 0), S(14, 0), S(16, 4), S(18,  9), S(2*28, 2*28), S(2*52, 2*104), S(2*118, 2*236) }, 
    { S(0, 0), S(16, 0), S(18, 5), S(20, 10), S(2*30, 2*30), S(2*54, 2*108), S(2*120, 2*240) }, 
    { S(0, 0), S(16, 0), S(18, 5), S(20, 10), S(2*30, 2*30), S(2*54, 2*108), S(2*120, 2*240) }, 
    { S(0, 0), S(17, 0), S(19, 6), S(22, 11), S(2*33, 2*33), S(2*59, 2*118), S(2*127, 2*254) }, 
    { S(0, 0), S(17, 0), S(19, 6), S(22, 11), S(2*33, 2*33), S(2*59, 2*118), S(2*127, 2*254) }, 
    { S(0, 0), S(16, 0), S(18, 5), S(20, 10), S(2*30, 2*30), S(2*54, 2*108), S(2*120, 2*240) }, 
    { S(0, 0), S(16, 0), S(18, 5), S(20, 10), S(2*30, 2*30), S(2*54, 2*108), S(2*120, 2*240) }, 
    { S(0, 0), S(14, 0), S(16, 4), S(18,  9), S(2*28, 2*28), S(2*52, 2*104), S(2*118, 2*236) }
